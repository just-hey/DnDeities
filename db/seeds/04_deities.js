...
{id: 52, name: 'Zeus', of: 'god of the sky, ruler of the gods', alignment: 5, level: '',
active: true, url: '', symbol: 'Fist full of lightning bolts', pantheon: 3, gender: 'male'},
{id: 53, name: 'Aphrodite', of: 'goddess of love and beauty', alignment: 3, level: '',
active: true, url: '', symbol: 'Sea shell', pantheon: 3, gender: 'female'},
{id: 54, name: 'Apollo', of: 'god of light, music, and healing', alignment: 3, level: '',
active: true, url: '', symbol: 'Lyre', pantheon: 3, gender: 'male'},
{id: 55, name: 'Ares', of: 'god of war and strife', alignment: 9, level: '',
active: true, url: '', symbol: 'Spear', pantheon: 3, gender: 'male'},
{id: 56, name: 'Artemis', of: 'goddess of hunting and childbirth', alignment: 2, level: '',
active: true, url: '', symbol: 'Bow and arrow on lunar disk', pantheon: 3, gender: 'female'},
{id: 57, name: 'Athena', of: 'goddess of wisdom and civilization', alignment: 1, level: '',
active: true, url: '', symbol: 'Owl', pantheon: 3, gender: 'female'},
{id: 58, name: 'Demeter', of: 'goddess of agriculture', alignment: 2, level: '',
active: true, url: '', symbol: 'Head of a Mare', pantheon: 3, gender: 'female'},
{id: 59, name: 'Dionysus', of: 'god of mirth and wine', alignment: 6, level: '',
active: true, url: '', symbol: 'Thyrsus (staff tipped with pine cone)', pantheon: 3, gender: 'male'},
{id: 60, name: 'Hades', of: 'god of the underworld', alignment: 7, level: '',
active: true, url: '', symbol: 'Black ram', pantheon: 3, gender: 'male'},
{id: 61, name: 'Hecate', of: 'goddess of magic and the moon', alignment: 9, level: '',
active: true, url: '', symbol: 'Setting moon', pantheon: 3, gender: 'female'},
{id: 62, name: 'Hephaestus', of: 'god of smithing and craft', alignment: 2, level: '',
active: true, url: '', symbol: 'Hammer and anvil', pantheon: 3, gender: 'male'},
{id: 63, name: 'Hera', of: 'goddess of marriage and intrigue', alignment: 6, level: '',
active: true, url: '', symbol: 'Fan of peacock feathers', pantheon: 3, gender: 'female'},
{id: 64, name: 'Hercules', of: 'god of strength and adventure', alignment: 3, level: '',
active: true, url: '', symbol: 'Head of a Lion', pantheon: 3, gender: 'male'},
{id: 65, name: 'Hermes', of: 'god of travel and commerce', alignment: 3, level: '',
active: true, url: '', symbol: 'Caduceus (winged staff and serpents)', pantheon: 3, gender: 'male'},
{id: 66, name: 'Hestia', of: 'goddess of home and family', alignment: 2, level: '',
active: true, url: '', symbol: 'Hearth', pantheon: 3, gender: 'female'},
{id: 67, name: 'Nike', of: 'goddess of victory', alignment: 4, level: '',
active: true, url: '', symbol: 'Winged woman', pantheon: 3, gender: 'female'},
{id: 68, name: 'Pan', of: 'god of nature', alignment: 6, level: '',
active: true, url: '', symbol: 'Syrinx (pan pipes)', pantheon: 3, gender: 'female'},
{id: 69, name: 'Poseidon', of: 'god of the sea and earthquakes', alignment: 6, level: '',
active: true, url: '', symbol: 'Trident', pantheon: 3, gender: 'male'},
{id: 70, name: 'Tyche', of: 'goddess of good fortune', alignment: 5, level: '',
active: true, url: '', symbol: 'Red pentagram', pantheon: 3, gender: 'female'},
{id: 71, name: 'Re-Horakhty', of: 'god of the sun, ruler of the gods', alignment: 1, level: '',
active: true, url: '', symbol: 'Solar disk encircled by serpent', pantheon: 4, gender: 'male'},
{id: 72, name: 'Anubis', of: 'god of judgment and death', alignment: 4, level: '',
active: true, url: '', symbol: 'Black jackal', pantheon: 4, gender: 'male'},
{id: 73, name: 'Apep', of: 'god of evil, fire, and serpents', alignment: 8, level: '',
active: true, url: '', symbol: 'Flaming snake', pantheon: 4, gender: 'male'},
{id: 74, name: 'Bast', of: 'goddess of cats and vengeance', alignment: 3, level: '',
active: true, url: '', symbol: 'Cat', pantheon: 4, gender: 'female'},
{id: 75, name: 'Bes', of: 'god of luck and music', alignment: 6, level: '',
active: true, url: '', symbol: 'Image of the misshapen deity', pantheon: 4, gender: 'male'},
{id: 76, name: 'Hathor', of: 'goddess of love, music, and motherhood', alignment: 2, level: '',
active: true, url: '', symbol: 'Horned cow’s head with lunar disk', pantheon: 4, gender: 'female'},
{id: 77, name: 'Imhotep', of: 'god of crafts and medicine', alignment: 2, level: '',
active: true, url: '', symbol: 'Step pyramid', pantheon: 4, gender: 'male'},
{id: 78, name: 'Isis', of: 'goddess of fertility and magic', alignment: 2, level: '',
active: true, url: '', symbol: 'Ankh and star', pantheon: 4, gender: 'female'},
{id: 79, name: 'Nephthys', of: 'goddess of death and grief', alignment: 3, level: '',
active: true, url: '', symbol: 'Horns around a lunar disk', pantheon: 4, gender: 'female'},
{id: 80, name: 'Osiris', of: 'god of nature and the underworld', alignment: 1, level: '',
active: true, url: '', symbol: 'Crook and flail', pantheon: 4, gender: 'male'},
{id: 81, name: 'Ptah', of: 'god of crafts, knowledge, and secrets', alignment: 4, level: '',
active: true, url: '', symbol: 'Bull', pantheon: 4, gender: 'male'},
{id: 82, name: 'Set', of: 'god of darkness and desert storms', alignment: 9, level: '',
active: true, url: '', symbol: 'Coiled cobra', pantheon: 4, gender: 'male'},
{id: 83, name: 'Sobek', of: 'god of water and crocodiles', alignment: 7, level: '',
active: true, url: '', symbol: 'Crocodile head with horns and plumes', pantheon: 4, gender: 'male'},
{id: 84, name: 'Thoth', of: 'god of knowledge and wisdom', alignment: 5, level: '',
active: true, url: '', symbol: 'Ibis', pantheon: 4, gender: 'male'},
{id: 85, name: 'Odin', of: 'god of knowledge and war', alignment: 2, level: '',
active: true, url: '', symbol: 'Watching blue eye', pantheon: 5, gender: 'male'},
{id: 86, name: 'Aegir', of: 'god of the sea and storms	', alignment: 8, level: '',
active: true, url: '', symbol: 'Rough ocean waves', pantheon: 5, gender: 'male'},
{id: 87, name: 'Balder', of: 'god of beauty and poetry', alignment: 2, level: '',
active: true, url: '', symbol: 'Gem-encrusted silver chalice', pantheon: 5, gender: 'male'},
{id: 88, name: 'Forseti', of: 'god of justice and law', alignment: 5, level: '',
active: true, url: '', symbol: 'Head of a bearded man', pantheon: 5, gender: 'male'},
{id: 89, name: 'Frey', of: 'god of fertility and the sun', alignment: 2, level: '',
active: true, url: '', symbol: 'Ice-blue greatsword', pantheon: 5, gender: 'male'},
{id: 90, name: 'Freya', of: 'goddess of fertility and love', alignment: 2, level: '',
active: true, url: '', symbol: 'Falcon', pantheon: 5, gender: 'female'},
{id: 91, name: 'Frigga', of: 'goddess of birth and fertility', alignment: 5, level: '',
active: true, url: '', symbol: 'Cat', pantheon: 5, gender: 'female'},
{id: 92, name: 'Heimdall', of: 'god of watchfulness and loyalty', alignment: 1, level: '',
active: true, url: '', symbol: 'Curling musical horn', pantheon: 5, gender: 'male'},
{id: 93, name: 'Hel', of: 'goddess of the underworld', alignment: 8, level: '',
active: true, url: '', symbol: 'Face of a woman, rotting on one side', pantheon: 5, gender: 'female'},
{id: 94, name: 'Hermod', of: 'god of luck', alignment: 6, level: '',
active: true, url: '', symbol: 'Winged scroll', pantheon: 5, gender: 'male'},
{id: 95, name: 'Loki', of: 'god of thieves and trickery', alignment: 9, level: '',
active: true, url: '', symbol: 'Flame', pantheon: 5, gender: 'male'},
{id: 96, name: 'Njord', of: 'god of sea and wind', alignment: 2, level: '',
active: true, url: '', symbol: 'Gold coin', pantheon: 5, gender: 'male'},
{id: 97, name: 'Odur', of: 'god of light and the sun', alignment: 3, level: '',
active: true, url: '', symbol: 'Solar disk', pantheon: 5, gender: 'male'},
{id: 98, name: 'Sif', of: 'goddess of war', alignment: 3, level: '',
active: true, url: '', symbol: 'Upraised sword', pantheon: 5, gender: 'female'},
{id: 99, name: 'Skadi', of: 'god of earth and mountains', alignment: 5, level: '',
active: true, url: '', symbol: 'Mountain peak', pantheon: 5, gender: 'male'},
{id: 100, name: 'Surtur', of: 'god of fire giants and war', alignment: 7, level: '',
active: true, url: '', symbol: 'Flaming sword', pantheon: 5, gender: 'male'},
{id: 101, name: 'Thor', of: 'god of storms and thunder	', alignment: 3, level: '',
active: true, url: '', symbol: 'Hammer', pantheon: 5, gender: 'male'},
{id: 102, name: 'Thrym', of: 'god of frost giants and cold', alignment: 9, level: '',
active: true, url: '', symbol: 'White double-bladed axe', pantheon: 5, gender: 'male'},
{id: 103, name: 'Tyr', of: 'god of courage and strategy', alignment: 4, level: '',
active: true, url: '', symbol: 'Sword', pantheon: 5, gender: 'male'},
{id: 104, name: 'Uller', of: 'god of hunting and winter', alignment: 6, level: '',
active: true, url: '', symbol: 'Longbow', pantheon: 5, gender: 'male'},
